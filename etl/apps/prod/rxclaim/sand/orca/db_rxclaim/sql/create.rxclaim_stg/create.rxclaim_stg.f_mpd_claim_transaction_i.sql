DROP TABLE ${STAGING_SCHEMA}.f_mpd_claim_transaction_i;

CREATE TABLE ${STAGING_SCHEMA}.f_mpd_claim_transaction_i
...
, run_id                           BIGINT
, rec_stat_cd                      BYTEINT
, fpd_formulary_stat               VARCHAR(18)
, fpd_qty_limits                   CHAR(1)
, fpd_prior_auth_rqrd_flg          CHAR(1)
, fpd_step_therapy_rqrd_flg        CHAR(1)
, sec_diff_amt                     DECIMAL(14,2)
, sec_prim_pp                      DECIMAL(14,2)
, sec_typ                          CHAR(1)
