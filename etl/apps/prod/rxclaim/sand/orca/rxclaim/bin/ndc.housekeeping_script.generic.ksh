...
curr_run_id=`cat $AI_SERIAL/ndc_reports/ndc_config_generic.dat| awk -F '|' '{print $1}'`;
...
echo $AI_SERIAL/ndc_reports/ndc_config_generic.dat >> $AI_SERIAL/ndc_reports/'ndc_cleanup_file_list.'$curr_run_id'.dat';
cp $AI_SERIAL/ndc_reports/ndc_config_generic.dat $AI_SERIAL/ndc_reports/ndc_config_generic.dat_$curr_run_id
